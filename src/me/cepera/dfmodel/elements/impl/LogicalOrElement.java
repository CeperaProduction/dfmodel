...
public class LogicalOrElement extends ElementBase<LogicalOrElement>{

	private boolean delay;
	private boolean lastValue;
	
	public LogicalOrElement(IElementFactory<LogicalOrElement> factory) {
		super(factory);
	...
	@Override
	protected void copyState(LogicalOrElement from) {
		this.delay = from.delay;
	}

	@Override
	public boolean statesEquals(IElement another) {
		return another instanceof LogicalOrElement
				&& ((LogicalOrElement)another).delay == this.delay;
	}
