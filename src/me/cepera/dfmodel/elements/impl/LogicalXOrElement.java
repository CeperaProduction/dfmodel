...
public class LogicalXOrElement extends ElementBase<LogicalXOrElement>{
	...
	@Override
	protected void copyState(LogicalXOrElement from) {
		this.delay = from.delay;
	}

	@Override
	public boolean statesEquals(IElement another) {
		return another instanceof LogicalXOrElement
				&& ((LogicalXOrElement)another).delay == this.delay;
	}
